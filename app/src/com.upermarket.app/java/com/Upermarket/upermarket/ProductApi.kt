...
interface OpenFoodFactsApi {
    ...
    suspend fun searchProducts(
        ...
        // Optimisation de la vitesse : on ne télécharge que l'essentiel pour la liste
        @Query("fields") fields: String = "code,product_name,image_front_url,brands,nutriscore_grade,ecoscore_grade,nova_group,quantity,categories,additives_n,nutrient_levels",
