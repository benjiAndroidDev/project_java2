...
data class PriceComparison(val storeName: String, val logoRes: Int, val totalPrice: Float)
...
class CartViewModel(context: Context, private val uid: String) : ViewModel() {
    ...
    var selectedType by mutableStateOf(prefs.getString("selected_type", "Drive") ?: "Drive")
    ...
    fun getPriceComparisons(): List<PriceComparison> {
        if (cartItems.isEmpty()) return emptyList()
        val base = totalPrice
        return listOf(
            PriceComparison("E.Leclerc", R.drawable.e_leclerc_logo_svg, base * 0.94f),
            PriceComparison("Lidl", R.drawable.lidl_logo_svg, base * 0.92f),
            PriceComparison("Carrefour", R.drawable.carrefour_logo_1982, base * 0.98f),
            PriceComparison("Auchan", R.drawable.logo_auchan__2015__svg, base * 1.01f),
            PriceComparison("Intermarché", R.drawable.nouveau_logo_intermarche, base * 0.97f),
            PriceComparison("Monoprix", R.drawable.monoprix, base * 1.12f),
            PriceComparison("Franprix", R.drawable.franprix, base * 1.10f),
            PriceComparison("Netto", R.drawable.french_netto_logo_2019_svg, base * 0.93f),
            PriceComparison("Casino", R.drawable.casino_supermarket_logo, base * 1.15f)
